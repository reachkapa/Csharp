    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                w.Until(ExpectedConditions.ElementExists(By.Id("btnSelectContactMain"))).Click();
                w.Until(ExpectedConditions.ElementExists(By.XPath("//input[@name='users']"))).SendKeys("pcontact1.finance");
                w.Until(ExpectedConditions.ElementExists(By.XPath("//div[text() = ' pcontact1.Finance@cloud9.cabnet ']"))).Click();
                ...
                w.Until(ExpectedConditions.ElementExists(By.XPath("//span[text()='Select All']"))).Click();
                w.Until(ExpectedConditions.ElementExists(By.XPath("//span[text()='Select all to validate']"))).Click();
                w.Until(ExpectedConditions.ElementExists(By.Id("btnValidate"))).Click();
                ...
                datePicker.Click();
                w.Until(ExpectedConditions.ElementExists(By.Id("calendar_control"))).SendKeys("21/08/2022");
