    ...
    class Sponsoring_CLO_Create_Cabinet_Item
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                // Enter user id 
                idriver.FindElement(By.Id("userNameInput")).SendKeys(@"cloud9\pclo1.agd");
                // Enter password
                idriver.FindElement(By.Id("passwordInput")).SendKeys(@"Welcome01!");
                // Click on submit
                idriver.FindElement(By.Id("submitButton")).Click();
               
                //T&C Check if it exists
                Thread.Sleep(500);
                string tAndCsUrl = idriver.Url;
                if (tAndCsUrl.Contains("organisation/tc"))
                {
                    TestUtils.TandCs(idriver);
                }
                ...
                //Select Product Type
                TestUtils.SelectFromDropdown(idriver, "cabinetProductTypeId");
                //Select the Sponsoring Minister
                TestUtils.SelectFromDropdown(idriver, "sponsoringMinisterId");
                //Select the Sponsoring Ministerial Title
                TestUtils.SelectFromDropdown(idriver, "sponsoringMinisterialTitleId");
                ...
                TestUtils.SelectFromDropdown(idriver, "meetingTypeId");
                //Scroll the page
                ...
                TestUtils.SelectFromDropdown(idriver, "expectedConsiderationTimePeriodType");
                //select Random Meeting date
                TestUtils.SelectFromDropdown(idriver, "expectedConsiderationId");
                //Input the purpose
